...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Dashboard de saúde, academias, clínicas próximas, notícias e assistente de IA preventivo." },
      { property: "og:title", content: "Saúde + Saudável" },
      { name: "twitter:title", content: "Saúde + Saudável" },
      { property: "og:description", content: "Dashboard de saúde, academias, clínicas próximas, notícias e assistente de IA preventivo." },
      { name: "twitter:description", content: "Dashboard de saúde, academias, clínicas próximas, notícias e assistente de IA preventivo." },
